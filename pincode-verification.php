...
{
$_SESSION['msg']="Error :sai mã pin, vui lòng nhập lại !!";
}
}
?>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Xác thực mã pin</h1>
                    </div>
                </div>
                <div class="row" >
...
<font color="red" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
   ...
   <div class="form-group">
    <label for="pincode">Nhập mã xác thực</label>
    <input type="password" class="form-control" id="pincode" name="pincode" placeholder="Mã xác thực" required />
  </div>
 
  <button type="submit" name="submit" class="btn btn-default">Xác nhận</button>
                           <hr />
