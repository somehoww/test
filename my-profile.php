...
{ ?>
 ...
 <div class="form-group">
    <label for="studentregno">Mã số sinh viên   </label>
...
<div class="form-group">
    <label for="Pincode">Mã xác thực  </label>
...
<div class="form-group">
    <label for="Pincode">Ảnh hồ sơ </label>
...
<div class="form-group">
    <label for="Pincode">Cập nhật ảnh </label>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">Cập nhật</button>
</form>
                            </div>
                            </div>
                    </div>
