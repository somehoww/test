...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysqli_query($bd, "insert into courseenrolls(studentRegno,pincode,session,department,course,semester) values('$studentregno','$pincode','$session','$dept','$course','$sem')");
if($ret)
{
...
{
  $_SESSION['msg']="Lỗi : không thể đăng ký !!";
}
}
?>
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Đăng ký môn học </h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="Session">Buổi học </label>
    <select class="form-control" name="session" required="required">
   <option value="">Chọn buổi học</option>   
   <?php 
...
<div class="form-group">
    <label for="Department">Phòng học </label>
    <select class="form-control" name="department" required="required">
   <option value="">Chọn phòng học</option>   
   <?php 
...
<div class="form-group">
    <label for="Semester">Kỳ học</label>
    <select class="form-control" name="sem" required="required">
   <option value="">Chọn kỳ học</option>   
   <?php 
...
<div class="form-group">
    <label for="Course">Môn học </label>
...
<?php } ?>
 ...
 <button type="submit" name="submit" id="submit" class="btn btn-default">Đăng ký</button>
</form>
                            </div>
                            </div>
                    </div>
